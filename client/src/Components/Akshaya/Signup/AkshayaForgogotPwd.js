...
function AkshayaForgogotPwd() {
    ...
    const validate = () => {
      ...
      const handleLogin = async (e) => {
        ...
        try {
          const result = await forgotPassword(data,'forgotPasswordAkshaya');
        ...
        <div className='container'>
          ...
          <p className='vo-pwd-para mt-5'>Enter your E-mail below to receive your password reset instruction</p>
                <form onSubmit={handleLogin}>
                  ...
                  <button
                  type="submit"
                  className="btn btn-success admin-login-button mt-5 mb-5"
                  >Next</button>
                </form>
...
export default AkshayaForgogotPwd