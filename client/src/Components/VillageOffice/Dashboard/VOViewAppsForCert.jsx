...
const navigate=useNavigate()
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                const result = await ViewById('viewAprvdAppByVoIdforVO', localStorage.getItem('vo'));
...
export default VOViewAppsForCert